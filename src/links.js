...
// Свой адрес целиком. Нужен там, где относительной ссылки мало: Open Graph
// требует абсолютных адресов, иначе соцсеть не найдёт картинку превью.
// Отсюда же берётся домен для файла CNAME при сборке.
export const SITE_URL = 'https://lazerklin.ru';
